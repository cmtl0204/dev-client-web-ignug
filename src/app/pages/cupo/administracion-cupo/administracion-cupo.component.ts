...
@Component({
    selector: 'app-administracion-cupo',
    templateUrl: './administracion-cupo.component.html'
})
export class AdministracionCupoComponent implements OnInit {
